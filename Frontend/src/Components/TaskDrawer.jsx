...
function TaskDrawer({ selectedTask, selectedTeam, onClose }) {
  ...
  return (
    <div className="
      p-4 bg-gray-900 text-white rounded-md shadow-lg relative z-60
    ...
    ">
                      ...
                      <div className="flex items-center space-x-3">
                        <button 
                          onClick={() => {
                            ...
                            setShowUploadWindow(stage.status==="Pending");
                          }}
      ...
      {showUpdateModal && (
        <div className="fixed inset-0 bg-black/50 bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 p-6 rounded-lg w-full max-w-md mx-auto max-h-[80vh] overflow-y-auto">
