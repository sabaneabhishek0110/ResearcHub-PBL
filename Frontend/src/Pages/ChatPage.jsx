  ...
  return (
    <div className="flex h-screen bg-gray-900 overflow-hidden">
      ...
      <div className="hidden md:flex w-full h-full">
        ...
        <div className={`w-80 bg-gray-800 text-white flex flex-col border-r border-gray-700 relative`}>
          {/* Sidebar Header */}
          <div className="p-4 border-b border-gray-700">
            <h2 className="text-xl font-semibold mb-4">Contacts</h2>
            <div className="flex flex-col space-y-4">
      ...
      {showFabMenu && (
        <div 
          className="fixed inset-0 z-50 flex justify-end items-end p-6"
          onClick={() => setShowFabMenu(false)}
        >
          <div 
            className="bg-gray-800 text-white rounded-lg p-4 w-full max-w-xs shadow-xl"
          ...
          >
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full text-left px-4 py-3 bg-gray-700 rounded hover:bg-gray-600 flex items-center gap-3"
              >
